...
public class ComponentesVentana {
    ...
    public static JLabel crearLabel(String texto, int x, int y, int ancho, int alto, String colorFuente, boolean visible, JPanel jp) {
    ...
    public static JTextField crearTextField(int x, int y, int ancho, int alto, boolean visible, boolean enabled, String color, JPanel jp) {
    ...
    public static JButton crearBoton(String texto, int x, int y, int ancho, int alto, int tamanoLetra, String color, JPanel jp) {
