...
public class VentanaComprar extends JFrame {
	...
	public VentanaComprar(Cliente cliente) {
		...
		txtPrincipal = ComponentesVentana.crearLabel("COMPRAR",280, 10, 180, 25, "#F1F0EE", true, jp);
		txtPrincipal.setFont(new Font("Gill Sans Nova", Font.BOLD, 16));
		
		txtPrincipal = ComponentesVentana.crearLabel("Para seleccionar varios productos al mismo tiempo mantén pulsado CONTROL.",40, 325, 540, 24, "#6384A6", true, jp);
		txtPrincipal.setFont(new Font("Arial", Font.ITALIC, 12));
